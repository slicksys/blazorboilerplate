...
namespace SSDCPortal.SourceGenerator
{
    [Generator]
    public class AuditableGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol interfaceSymbol = context.Compilation.GetTypeByMetadataName("SSDCPortal.Infrastructure.Storage.DataInterfaces.IAuditable");
