...
using SSDCPortal.Infrastructure.Storage;
using SSDCPortal.Infrastructure.Storage.DataModels;
using SSDCPortal.Infrastructure.Storage.Permissions;
using SSDCPortal.Server.Authorization;
using SSDCPortal.Server.Extensions;
using SSDCPortal.Server.Factories;
using SSDCPortal.Server.Managers;
using SSDCPortal.Server.Middleware;
using SSDCPortal.Shared.Dto.ExternalAuth;
using SSDCPortal.Shared.Interfaces;
using SSDCPortal.Shared.Localizer;
using SSDCPortal.Shared.Models;
using SSDCPortal.Shared.Providers; //ServerSideBlazor
using SSDCPortal.Shared.Services;
using SSDCPortal.Shared.Validators.Db;
using SSDCPortal.Storage;
using SSDCPortal.Storage.Mapping;
...
namespace SSDCPortal.Server
{
    public class Startup
    {
        ...
        private readonly string projectName = nameof(SSDCPortal);

        public Startup(IConfiguration configuration, IWebHostEnvironment env)
        {
            Configuration = configuration;
            _environment = env;
            _enableAPIDoc = configuration.GetSection("SSDCPortal:Api:Doc:Enabled").Get<bool>();
        }
