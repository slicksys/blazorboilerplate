using SSDCPortal.Infrastructure.Extensions;
...
namespace SSDCPortal.Server.Middleware
{
    ...
    public class APIResponseRequestLoggingMiddleware : BaseMiddleware
    {
        ...
        {
            _enableAPILogging = configuration.GetSection("SSDCPortal:Api:Logging:Enabled").Get<bool>();
            _clearCacheHeadersDelegate = ClearCacheHeaders;
            _ignorePaths = configuration.GetSection("SSDCPortal:Api:Logging:IgnorePaths").Get<List<string>>() ?? new List<string>();
        }
