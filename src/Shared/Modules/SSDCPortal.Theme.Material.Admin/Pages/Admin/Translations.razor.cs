...
namespace SSDCPortal.Theme.Material.Admin.Pages.Admin
{
    public class TranslationsPage : ComponentBase
    {
        ...
        protected async Task SaveNewPlural()
        {
            ...
            if (currentLocalizationRecord.Culture == SSDCPortal.Shared.Localizer.Settings.NeutralCulture
                && newPlural.Index == 1)
        ...
        {
            var msgIdPlural = localizationRecords.Single(i => i.Culture == SSDCPortal.Shared.Localizer.Settings.NeutralCulture)
